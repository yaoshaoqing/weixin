...
<link href="__PUBLIC__/css/lyz.calendar.css" rel="stylesheet" />
<script type="text/javascript" src="__PUBLIC__/js/jquery-3.1.1.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/js/lyz.calendar.min.js" ></script>
...
<script src="https://kyfw.12306.cn/otn/resources/js/framework/jquery.bgiframe.mi.js" type="text/javascript" xml:space="preserve"></script>
    ...
    <body>
        <input type="hidden" id="upperLimit" value="{$upperLimit}"><input type="hidden" id="date" value="{$date}">
