...
<TABLE cellSpacing=0 cellPadding=0 width=651 align=center border=0>
  ...
  <TR>
    <TD height=351><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD width=15 background=/Public/admin/images/ileft.gif height=43></TD>
          <TD width=620 background=/Public/admin/images/i_topbg2.gif><IMG 
            height=43 src="/Public/admin/images/i_top1.gif" width=43></TD>
          <TD width=16><IMG height=43 src="/Public/admin/images/iright.gif" 
            width=16></TD>
        </TR>
        <TR>
          <TD background=/Public/admin/images/ileftbg.gif></TD>
          <TD vAlign=center background=/Public/admin/images/bg.gif height=279><TABLE height=109 cellSpacing=0 cellPadding=0 width=369 align=center 
            border=0>
              <TBODY>
              
              <TR>
                <TD width=155><IMG height=140 
                  src="/Public/admin/images/logo.jpg" width=155 useMap=#Map 
                  border=0></TD>
                <TD vAlign=top align=left width=214><TABLE cellSpacing=0 cellPadding=0 width=167 border=0>
                    ...
                    <TR>
                      <TD vAlign=bottom width=167 height=30><A 
                        href="#"><IMG 
                        height=19 src="/Public/admin/images/adminsyteam.gif" 
                      ...
                      <TD height=123><TABLE height=109 cellSpacing=0 cellPadding=0 
                        align=center border=0>
                          <FORM  action=login method=post>
                              ...
                              src="/Public/admin/images/id.gif" width=43></DIV></TD>
                              ...
                              src="/Public/admin/images/pass.gif" 
                            width=43></DIV></TD>
          ...
          <TD background=/Public/admin/images/irightbg.gif></TD>
        </TR>
        <TR>
          <TD><IMG height=29 src="/Public/admin/images/i_bottom_left.gif" 
            width=15></TD>
          <TD background=/Public/admin/images/i_bottom_bg.gif></TD>
          <TD width=16><IMG height=29 
            src="/Public/admin/images/i_bottom_right.gif" 
      width=16></TD>
        </TR>
        </TBODY>
      </TABLE></TD>
