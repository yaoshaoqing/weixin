...
width:158px;
height:100%;
background:url(/Public/admin/images/slide.jpg) repeat-y;
position:absolute;
left:0px;
}
#lhead{
background:url(/Public/admin/images/left-head.jpg) left top no-repeat;
height:25px;
	font-size:14px;
	color:#FF9933;
    text-align:center;
...
#topDiv{
	...
	background:url(/Public/admin/images/head-bg.jpg) repeat-x;
	position:absolute;
	top:0px;
	overflow:hidden;
}
...
height:25px;
line-height:25px;
background:url(/Public/admin/images/menu-bg.jpg) repeat-x;
color:#FFFFFF;
direction:none;
text-align:center;
...
#bottomDiv{
	width:100%;
	height:20px;
	background:url(/Public/admin/images/bottom.jpg) repeat-x;
	position:absolute;
	bottom:0px;
...
background:url(/Public/admin/images/menu-bg.jpg) 0px 25px;
color:#99FFCC;
direction:none;
text-align:center;
border-bottom:1px #000066 solid;
